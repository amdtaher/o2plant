...
const Page = () => {
  ...
  return (
    <>
      <div className='flex flex-col lg:flex-row items-center justify-between gap-20 py-6 md:py-12 md:px-16'>
        {/* Hero Text */}
        <div className='flex flex-col gap-20 md:gap-30'>
          ...
          <div className='md:max-w-[450px] flex flex-col items-start justify-between gap-2.5 px-8 py-12 bg-white/5 backdrop-blur-[10.1px] border border-white/40 border-r-white/20 rounded-[45px] mx-5 md:mx-0'>
            <div className='flex items-center justify-between gap-5'>
              <Image width={64} height={64} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" src='/images/hero-review-img.webp' alt='Reviewer-image'/>
        ...
        {/* Hero Img */}
        <Carousel  className="w-full max-w-sm md:max-w-lg lg:mr-10">
          <CarouselContent>
            {plants.map((plant, index) => (
              <CarouselItem key={index}>
                <div className="embla" ref={emblaRef}>
                  <div className='embla__container'>
                      <div className='embla__slide md:h-[610px] bg card-bg flex flex-col items-center justify-center pb-10 md:pb-12 text-white/70 mt-30 pt-20 md:pt-0'>
                        <Image width={459} height={459} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className='-mt-32' src={plant.img} alt='Hero-Plants-images'/>
                        <div className='relative flex flex-col gap-2 md:gap-3 capitalize'>
                          ...
                          <CarouselNext className={`hidden md:flex absolute bottom-0 -right-20`}/>
                        </div>
                      </div>
                  </div>
                </div>
