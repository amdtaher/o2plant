            ...
            {feedbacks.map( feed => (
              <div key={feed.id} className='flex flex-col items-start justify-between gap-6 px-5 py-8 md:py-12 bg-white/5 backdrop-blur-[10.1px] border border-white/40 border-r-white/20 border-t-0 rounded-[45px]'>
                <div className='flex items-center justify-between gap-5'>
                  <Image src={feed.img} className='rounded-full w-[70px] h-[70px] leading-1 object-cover' width={88} height={88} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" alt='feed-reviewer-img'/>
